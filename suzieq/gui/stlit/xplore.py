...
class XplorePage(SqGuiPage):
    ...
    def _get_state_from_url(self):
        ...
        if self._first_time and self._title in page:
            ...
            if url_params and not all(not x for x in url_params.values()):
                ...
                self._state = XploreSessionState(**url_params)
    ...
    def _draw_aggrid_df(self, layout, df):
        ...
        # jscode = self._aggrid_style(self._state.table)
        # gb.configure_column("state", cellStyle=jscode)
